...
public class UserStyleElement {
     ...
     * This is why there is not a <CODE>set</CODE> method for the abstractStyle property.
     * 
     * <p>
    ...
    public List<JAXBElement<? extends AbstractStyleType>> getAbstractStyle() {
        if (abstractStyle == null) {
            abstractStyle = new ArrayList<JAXBElement<? extends AbstractStyleType>>();
        }
        return this.abstractStyle;
    }

    public boolean isSetAbstractStyle() {
        return ((this.abstractStyle!= null)&&(!this.abstractStyle.isEmpty()));
    }

    public void unsetAbstractStyle() {
        this.abstractStyle = null;
    }
