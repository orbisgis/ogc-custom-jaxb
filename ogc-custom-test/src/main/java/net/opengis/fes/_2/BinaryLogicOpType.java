    ...
    extends LogicOpsType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "spatialOps", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class),
        @XmlElementRef(name = "temporalOps", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class),
        @XmlElementRef(name = "Function", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class),
        @XmlElementRef(name = "_Id", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class),
        @XmlElementRef(name = "comparisonOps", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class),
        @XmlElementRef(name = "extensionOps", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class),
        @XmlElementRef(name = "logicOps", namespace = "http://www.opengis.net/fes/2.1", type = JAXBElement.class)
    })
